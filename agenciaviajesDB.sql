...
CREATE TABLE IF NOT EXISTS `testimoniales` (
  ...
  `correo` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `mensaje` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla agenciaviajes.testimoniales: ~0 rows (aproximadamente)
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
	(6, 'Camilo', 'camilo@correo.com', 'Excelentes vacaciones en Miami!!');
